...
>**`Experimental Build`** (optimized, but may not work on some devices): [v3.0.4](https://github.com/ancandi/YouTube-Mobile-URL-Shield-AB/raw/refs/heads/main/url-shield-ab+-test-beta.user.js)
